...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo">
		...
		<div id="arrastreImagenArticulo">
			<div id="imagenArticulo"><img src="/views/assets/images/backend/articulos/landscape01.jpg" class="img-thumbnail"></div>
		</div>
	...
	<ul id="editarArticulo">
		<li>
			...
			<img src="/views/assets/images/backend/articulos/landscape02.jpg" class="img-thumbnail">
			<h1>Lorem Ipsum</h1>
		...
		<li>
			...
			<div id="editarImagen"><span class="fa fa-times"></span><img src="/views/assets/images/backend/articulos/landscape03.jpg" class="img-thumbnail"></div>
...
<div id="articulo1" class="modal fade">
	...
	<img src="/views/assets/images/backend/articulos/landscape02.jpg" width="100%" style="margin-bottom:20px">
