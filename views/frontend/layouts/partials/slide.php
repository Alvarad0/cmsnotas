<div class="row">
	<div id="slide" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<ul>
		       <li>
	           	<img src="/views/assets/images/frotend/slide/slide01.jpg">
		       ...
		       <li>
	           	<img src="/views/assets/images/frotend/slide/slide02.jpg">
	           	<div class="slideCaption">
	           		<h3>Lorem Ipsum</h3>
			   		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
	           	</div>
		       ...
		       <li>
	           	<img src=/views/assets/images/frotend/slide/slide03.jpg>
	           	<div class="slideCaption">
	           		<h3>Lorem Ipsum</h3>
			   		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
	           	</div>
