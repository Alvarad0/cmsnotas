	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 jumbotron">
    		<h4 class="blockquote-reverse text-primary">
    			<ul>
	              <li><span class="fa fa-phone-square"></span>  (57)(4) 234 56 43</li>
	              <li><span class="fa fa-map-marker"></span>  Calle 45F 32 - 45</li>
	              <li><span class="fa fa-envelope"></span>  logotipo@correo.com</li>
	          	</ul>      
    		</h4>
			</div>
	</div>
